...
const Info = () => {
    return (
        ...
        <div className="flex items-center m-12 p-12 flex-row-reverse">
            <img className='sm:w-80 sm:mx-10' src={gambar4}/>
            <div className="w-full flex-col gap-2">
